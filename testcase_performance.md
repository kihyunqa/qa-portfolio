...
| TC-PERF-016 | JavaScript 파싱 시간 | 큰 스크립트 | 3초 이하 파싱 | P2 | DevTools |
| TC-PERF-017 | 스크롤 구간 | 페이지 스크롤 | 지연 없음 | P2 | Playwright |
...
**성능 TC 직접 구현 파일**: `playwright-tests/performance.spec.js`
