...
| TC-CICD-HP-007 | Actions 이력 확인 | GitHub UI 에서 Actions 탭 | 실행 이력 및 상태 표시 | P2 |
...
| TC-CICD-NG-005 | 실제 타임아웃 | 네트워크 단절 시 | 연결 시간 초과 후 실패 처리 | P2 |
