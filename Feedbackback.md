...
0. **Hero 섹션** — 이름(성기현) + QA ENGINEER + CTA 버튼 3개. 설명문/태그 없음. 심플.
1. 숫자로 보는 현황 (stats)
2. MCP 자동화
3. 실제 연동 증거
4. 프로젝트 카드
...
8. 경력 타임라인
9. 스킬
10. footer (이메일/GitHub/Jira 링크)

**Contact 섹션 제거 완료** — nav에서도 연락 링크 제거. footer에 이메일/GitHub/Jira 링크만.

## ✅ 완료된 작업 (건드리지 말 것)

* hero 섹션 설명문(hero-desc) 제거 → 이름 + 직함 + CTA 버튼만 남김 ✅ STEP 106
* contact 섹션 전체 제거 ✅ STEP 106
* nav에서 연락 링크 제거 ✅ STEP 106
* footer에 이메일/GitHub/Jira 링크 통합 ✅ STEP 106
...
* 경력 타임라인 상세 내용 복원 (Feedbackback 기준 실제 경력으로) ✅ STEP 106
...
### 4. hero 섹션 문구 제거 ✅ STEP 106 완료

### 5. contact 섹션 제거 ✅ STEP 106 완료

## 미완료 작업

* 이력서 vs 경력기술서 차별화 (별도 세션, PDF 원본 필요)
* hero 헤드라인 최종 확정 (현재: 없음 — 이름+직함만. 유지 또는 변경 여부 미결)
...
*최종 업데이트: 2026-04-25 · STEP 106 완료*
*hero 설명문 제거, contact 섹션 제거, nav 연락 링크 제거, footer에 링크 통합*
*다음: hero 헤드라인 최종 확정 여부 / 이력서 vs 경력기술서 차별화 (PDF 원본 필요)*
