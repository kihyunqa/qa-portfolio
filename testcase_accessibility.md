...
| TC-A11Y-004 | Tab 키보드 | Tab 순서 네비 | 순서 없는 포커스 | WCAG 2.4.3 |
...
| TC-A11Y-015 | 모달 코마 | ESC키 닫기 | 포커스 복구 | WCAG 2.1.2 |
| TC-A11Y-016 | 자동 재생 가능 | 잠시 중지 버튼 | 제어 가능 | WCAG 2.2.2 |
| TC-A11Y-017 | 표 접근성 | `scope` 속성 | 헤더 연결 | WCAG 1.3.1 |
| TC-A11Y-018 | 이전 페이지 | 빠른 링크 | 포커스 제공 | WCAG 2.4.1 |
| TC-A11Y-019 | 개당 요소 | 44x44px 최소 | 클릭 영역 | WCAG 2.5.5 |
| TC-A11Y-020 | 소성 텍스트 | 200% 확대 | 레이아웃 무너짐 | WCAG 1.4.4 |

**접근성 TC 직 구현 파일**: `playwright-tests/accessibility.spec.js`  
